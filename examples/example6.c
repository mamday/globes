...
#define M_TEST 6        /* Index of non-standard parameter sigma_E */
...
//  sigma_E = glbGetOscParams(p, GLB_SIGMA_E);
  m_test = glbGetOscParams(p, M_TEST);
...
//  glbSetOscParams(p, sigma_E, GLB_SIGMA_E);
  glbSetOscParams(p, m_test, M_TEST);
...
//  glbSetOscParams(true_values,true_sigma_E, GLB_SIGMA_E);   /* Non-standard parameter */
  glbSetOscParams(true_values,true_m_test, M_TEST);   /* Non-standard parameter */
...
//  glbSetOscParams(test_values,true_sigma_E, GLB_SIGMA_E);   /* Non-standard parameter */
  glbSetOscParams(test_values,true_m_test, M_TEST);   /* Non-standard parameter */
  ...
  glbSetOscParams(input_errors, 0.0, M_TEST);      /* Non-standard parameter */
